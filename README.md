...
> Replace the placeholders below with your actual query results.

- **Revenue by region:** [Region] led with $[X] in closed-won revenue, followed by [Region] at $[X].
- **Best-converting lead source:** [Lead Source] had the highest win rate at [X]%, compared to [Lead Source] at [X]% — suggesting the team should prioritize [insight/recommendation].
- **Sales cycle length:** [Industry] deals closed fastest on average ([X] days), while [Industry] took longest ([X] days).
- **Top revenue driver:** [Company Name] was the single largest account, contributing $[X] in closed-won revenue.
- **Quarterly trend:** Revenue [grew/declined/fluctuated] from [X] in [Quarter] to [X] in [Quarter], a [X]% change.
